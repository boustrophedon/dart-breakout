...
final Set<String> server_transmit = new Set.from(["ServerPing", "NewPlayerCreated", "ServerPaddleUpdate", "PlayerLeft", "NewBallCreated", "ServerBallUpdate", "BallDeath", "NewBrickCreated","ServerBrickUpdate", "BrickBreak"]);
